...
class HtmlReporter:
    ...
    def report(self, morfs: Optional[Iterable[TMorf]]) -> float:
        ...
        if files_to_report:
            ...
            first_html = final_html = "material_list.html"
    ...
    def index_file(self, first_html, final_html):
        """Write the material_list.html file for this report."""
        self.make_directory()
        index_tmpl = Templite(read_data("material_list.html"), self.template_globals)
        ...
        index_file = os.path.join(self.directory, "material_list.html")
...
class IncrementalChecker:
    ...
    def index_info(self, fname):
        """Get the information for material_list.html for `fname`."""
        return self.files.get(fname, {}).get('index', {})

    def set_index_info(self, fname, info):
        """Set the information for material_list.html for `fname`."""
