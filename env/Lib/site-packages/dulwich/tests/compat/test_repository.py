...
class WorkingTreeTestCase(ObjectStoreTestCase):
    ...
    def create_new_worktree(self, repo_dir, branch):
        ...
        Args:
          repo_dir: The directory of the catalog working tree.
    ...
    def test_git_worktree_config(self):
        ...
        # Set some config value in the catalog repo using the git CLI
        require_git_version((2, 7, 0))
        test_name = "Jelmer"
        ...
        # Assert that both the worktree repo and catalog repo have the same view of the config,
