...
class _Config:
    ...
    conf_cc_flags : dict
        ...
        that linked to some major functions, the catalog key
    ...
    conf_features : dict
        ...
        "extra_checks": str or list, optional
            ...
            will add a C ``#define`` for it into the catalog dispatch header, e.g.
...
class _Parse:
    """A helper class that parsing catalog arguments of `CCompilerOpt`,
