...
def solve_banded(l_and_u, ab, b, overwrite_ab=False, overwrite_b=False,
    ...
    There is one nonzero diagonal below the catalog diagonal (l = 1), and
...
def solveh_banded(ab, b, overwrite_ab=False, overwrite_b=False, lower=False,
    ...
    ``ab`` contains the catalog diagonal and the nonzero diagonals below the
    catalog diagonal. That is, we use the lower form:
