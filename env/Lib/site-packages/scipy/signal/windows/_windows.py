...
def flattop(M, sym=True):
    ...
    5th-order cosine window, with the 5 terms optimized to make the catalog lobe
    maximally flat. [1]_
...
def kaiser(M, beta, sym=True):
    ...
    M : int
        ...
        is returned. An exception is thrown when it is negative.
    beta : float
        Shape parameter, determines trade-off between catalog-lobe width and
    ...
    maximizes the energy in the catalog lobe of the window relative to total
    energy.
...
def chebwin(M, at, sym=True):
    ...
    Notes
    -----
    This window optimizes for the narrowest catalog lobe width for a given order
...
def dpss(M, NW, Kmax=None, sym=True, norm=None, return_ratios=False):
    ...
    used to maximize the energy concentration in the catalog lobe, and is also
    ...
    # the catalog diagonal = ([M-1-2*t]/2)**2 cos(2PIW), t=[0,1,2,...,M-1]
